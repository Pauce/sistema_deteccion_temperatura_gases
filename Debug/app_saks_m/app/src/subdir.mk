...
C_DEPS += \
./app_saks_m/app/src/app_saksm.d \
./app_saks_m/app/src/process_extinction.d \
./app_saks_m/app/src/process_lcd.d \
./app_saks_m/app/src/process_rtc.d \
./app_saks_m/app/src/process_uart.d 

OBJS += \
./app_saks_m/app/src/app_saksm.o \
./app_saks_m/app/src/process_extinction.o \
./app_saks_m/app/src/process_lcd.o \
./app_saks_m/app/src/process_rtc.o \
./app_saks_m/app/src/process_uart.o 


# Each subdirectory must supply rules for building sources it contributes
app_saks_m/app/src/%.o: ../app_saks_m/app/src/%.c app_saks_m/app/src/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-app_saks_m-2f-app-2f-src

clean-app_saks_m-2f-app-2f-src:
	-$(RM) ./app_saks_m/app/src/app_saksm.d ./app_saks_m/app/src/app_saksm.o ./app_saks_m/app/src/process_extinction.d ./app_saks_m/app/src/process_extinction.o ./app_saks_m/app/src/process_lcd.d ./app_saks_m/app/src/process_lcd.o ./app_saks_m/app/src/process_rtc.d ./app_saks_m/app/src/process_rtc.o ./app_saks_m/app/src/process_uart.d ./app_saks_m/app/src/process_uart.o

.PHONY: clean-app_saks_m-2f-app-2f-src
