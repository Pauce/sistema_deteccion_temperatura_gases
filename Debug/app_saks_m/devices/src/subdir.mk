...
./app_saks_m/devices/src/ZC05.d \
./app_saks_m/devices/src/ZE07.d \
./app_saks_m/devices/src/mcp960x.d \
./app_saks_m/devices/src/rtc_device.d \
./app_saks_m/devices/src/wifi_ble_device.d 

OBJS += \
./app_saks_m/devices/src/WL0F0007000A8GAAASA00.o \
./app_saks_m/devices/src/ZC05.o \
./app_saks_m/devices/src/ZE07.o \
./app_saks_m/devices/src/mcp960x.o \
./app_saks_m/devices/src/rtc_device.o \
./app_saks_m/devices/src/wifi_ble_device.o 


# Each subdirectory must supply rules for building sources it contributes
app_saks_m/devices/src/%.o: ../app_saks_m/devices/src/%.c app_saks_m/devices/src/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-app_saks_m-2f-devices-2f-src

clean-app_saks_m-2f-devices-2f-src:
	-$(RM) ./app_saks_m/devices/src/WL0F0007000A8GAAASA00.d ./app_saks_m/devices/src/WL0F0007000A8GAAASA00.o ./app_saks_m/devices/src/ZC05.d ./app_saks_m/devices/src/ZC05.o ./app_saks_m/devices/src/ZE07.d ./app_saks_m/devices/src/ZE07.o ./app_saks_m/devices/src/mcp960x.d ./app_saks_m/devices/src/mcp960x.o ./app_saks_m/devices/src/rtc_device.d ./app_saks_m/devices/src/rtc_device.o ./app_saks_m/devices/src/wifi_ble_device.d ./app_saks_m/devices/src/wifi_ble_device.o

.PHONY: clean-app_saks_m-2f-devices-2f-src
