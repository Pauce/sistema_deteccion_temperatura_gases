...
C_DEPS += \
./app_saks_m/fsm/src/fsm_gas.d 

OBJS += \
./app_saks_m/fsm/src/fsm_gas.o 


# Each subdirectory must supply rules for building sources it contributes
app_saks_m/fsm/src/%.o: ../app_saks_m/fsm/src/%.c app_saks_m/fsm/src/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-app_saks_m-2f-fsm-2f-src

clean-app_saks_m-2f-fsm-2f-src:
	-$(RM) ./app_saks_m/fsm/src/fsm_gas.d ./app_saks_m/fsm/src/fsm_gas.o

.PHONY: clean-app_saks_m-2f-fsm-2f-src
