...
C_SRCS += \
../app_saks_m/utilities/src/conversions.c 

C_DEPS += \
./app_saks_m/utilities/src/conversions.d 

OBJS += \
./app_saks_m/utilities/src/conversions.o 


# Each subdirectory must supply rules for building sources it contributes
app_saks_m/utilities/src/%.o: ../app_saks_m/utilities/src/%.c app_saks_m/utilities/src/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-app_saks_m-2f-utilities-2f-src

clean-app_saks_m-2f-utilities-2f-src:
	-$(RM) ./app_saks_m/utilities/src/conversions.d ./app_saks_m/utilities/src/conversions.o

.PHONY: clean-app_saks_m-2f-utilities-2f-src
