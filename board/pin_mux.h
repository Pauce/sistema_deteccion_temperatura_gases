...
/*! @name CAN0_RD (number 41), U25[3]/CAN_RXD
  @{ */
#define BOARD_INITDEBUG_UARTPINS_CAN_RXD_PORT 1U                   /*!<@brief PORT peripheral base pointer */
#define BOARD_INITDEBUG_UARTPINS_CAN_RXD_PIN 22U                   /*!<@brief PORT pin number */
#define BOARD_INITDEBUG_UARTPINS_CAN_RXD_PIN_MASK (1U << 22U)      /*!<@brief PORT pin mask */
                                                                   /* @} */
